describe('jms - repeating element attribute contains integer', function () {
  ...
  it('should report a mismatch where the actual repeating group element\'s attribute does not contain the expected value', function () {
    var expectedMessage = [
      {repeatingGroup: {path: 'elementOne.thingContainingRepeatingGroups', repeater: 'RepeatingGroup', number: 1}, path: 'fieldTwoOfRepeatingGroup', attribute: 'testAttribute2', contains: 1234},
      {repeatingGroup: {path: 'elementOne.thingContainingRepeatingGroups', repeater: 'RepeatingGroup', number: 2}, path: 'fieldTwoOfRepeatingGroup', attribute: 'testAttribute2', contains: 124}
    ];
      ...
      assert.deepEqual(result.checks[2], {
        ...
        path: 'elementOne.thingContainingRepeatingGroups.RepeatingGroup.fieldTwoOfRepeatingGroup number: 1 (attribute: testAttribute2)',
      ...
      assert.deepEqual(result.checks[4], {
        ...
        path: 'elementOne.thingContainingRepeatingGroups.RepeatingGroup.fieldTwoOfRepeatingGroup number: 2 (attribute: testAttribute2)',
    ...
    it('should report a match where the actual repeating group element\'s attribute value does contain the expected value', function () {
      var expectedMessage = [
        ...
        {repeatingGroup: {path: 'elementOne.thingContainingRepeatingGroups', repeater: 'RepeatingGroup', number: 2}, path: 'fieldTwoOfRepeatingGroup', attribute: 'testAttribute2', contains: 12}
      ];
